...
**The worst callback is not stable to the instruction.** Measured repeatedly against one checkout it comes back 8096, 8097 or 8098, so it is quoted as 8097 and a movement of one or two is the instrument rather than the dashboard. The other two are stable and repeat exactly.
